...
********** SW Time Limited Treatment over all scenarios*******;
/*  
...
****  7 clusters, ratio 7.4 vs 10.1, SD=0.85 (IQR from 5.6 to 18.8 in control condition) , ICC=0.05 ***;
...
%let delta_trt=%sysfunc( log(7.4/10.1) ); *levende patienten;
...
/*
**** 8 clusters, SD lager: IQR 3-11 (sd=0.96), ICC=0.05****************;
%macro clussize_ClusterTimeTrt(); 
clussize=15;
%mend;
%let sd=0.963; 
...
%sim_cluster_repmeas(n_clus=8, n_rep=17, delta_trt=&delta_trt, data_time_effects=data_time_effects,
sigma2_c=&sigma2_c, proc_options=%str(method=rspl),
n_sim=1000, sim_block=100,seedstartrow=1, dir='.', store=%str(work), ds_out=dir.c8_iqr03_11_icc005);
...
*********************** SW Bridge: 6 clusters, 13 periods ***********************;
/* 13 periods; 6 clusters as follows: 
C T i i i i i i i i i i i 
C C C T i i i i i i i i i 
C C C C C T i i i i i i i 
C C C C C C C T i i i i i 
C C C C C C C C C T i i i 
C C C C C C C C C C C T i
*/

/*

**** 6 clusters, SD lager: IQR 3-11 (sd=0.96), ICC lager: ICC=0.025****************;
%macro clussize_ClusterTimeTrt(); 
clussize=24;
%mend;
%let sd=0.963; 
...
%sim_cluster_repmeas(n_clus=6, n_rep=13, delta_trt=&delta_trt, data_time_effects=data_time_effects,
sigma2_c=&sigma2_c, proc_options=%str(method=rspl),
n_sim=1000, sim_block=100, seedstartrow=1, dir='.', store=%str(work), ds_out=dir.c6p13_iqr03_11_icc0025);
...
*********************** SW Bridge: 6 clusters, 15 periods ***********************;
/* 15 periods; 6 clusters as follows: 
C T i i i i i i i i i i i i i 
C C C T i i i i i i i i i i i
C C C C C T i i i i i i i i i
C C C C C C C T i i i i i i i
...
%sim_cluster_repmeas(n_clus=6, n_rep=15, delta_trt=&delta_trt, data_time_effects=data_time_effects,
sigma2_c=&sigma2_c, proc_options=%str(method=rspl),
n_sim=1000, sim_block=100, seedstartrow=1, dir='.', store=%str(work), ds_out=dir.c6p15_iqr03_11_icc0025);
