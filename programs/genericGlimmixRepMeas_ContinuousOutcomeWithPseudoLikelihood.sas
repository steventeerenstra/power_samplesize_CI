/* to do: proc mixed instead of proc glimmix; to incorporate more sim parameters in the dataset, via the analysis macro */
...
********** SW Bridge general over all scenarios*******;
/*  
...
do i=1 to &n_time_effects; time_effect{i}= 2.08+ (i-1)*( 0.001 )/ 10; *exp(2.08)=8;
...
*************** SCENARIOS *************************************************************;
**** 8 clusters****; 
/* 17 periods; 8 clusters as follows: 
C T i i i i i i i i i i i i i i i 
C C C T i i i i i i i i i i i i i
C C C C C T i i i i i i i i i i i
C C C C C C C T i i i i i i i i i 
...
/*
****  8 clusters, IQR van 2-12 (sd=1.33), ICC=0.05 ***;
...
n_sim=1000, sim_block=100,seedstartrow=1, dir='.', store=%str(work), ds_out=dir.c8_iqr02_12_icc005);
